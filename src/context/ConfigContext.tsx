...
const translations: Record<Language, Record<string, any>> = {
  ...
  ar: {
    ...
    compiling: "جارٍ استخلاص المواقف وإعادة صياغة المنظور المقابل...",
    seededClaims: "أو اختر مثالًا جاهزًا",
    select: "اختر ←",
    copyright: "«الجانب الآخر» © 2026 — محايدٌ بطبيعته.",
    neutralPositionGuarded: "موقفٌ محايدٌ ومحفوظ",
    demoMode: "نموذج تجريبي",
    intelBrief: "تقرير الجانب الآخر",
    detectedNarrative: "الرواية المرصودة",
    ...
    uncertaintyAreas: "مواطن عدم اليقين",
    sourceStrength: "مصدر",
