        ...
        {lang === 'ar' ? (
          <div className="space-y-8 font-light leading-relaxed text-sm">
            <section className="space-y-3">
              <h2 className="text-lg font-serif text-slate-900 dark:text-white font-medium">١. الامتناع التام عن إصدار الأحكام</h2>
              <p>
                لا يتولّى «الجانب الآخر» التحكيم في النزاعات، ولا يقرّر الصواب من الخطأ، ولا يُصدر أحكامًا نهائية. نحن نرفض اختزال المسائل المعقّدة في ثنائيةٍ مبسّطة. صُمّمت هذه الأداة لغرضٍ واحد: أن تعرض المنظور المقابل لأي رواية تُقدَّم إليها.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-serif text-slate-900 dark:text-white font-medium">٢. عرض الروايات المقابلة</h2>
              <p>
                ينطوي كل نزاعٍ عام على سياقاتٍ مُغفَلة، واختلافاتٍ في المنطلقات التأسيسية، وتفسيراتٍ متباينة للوقائع نفسها. غايتنا أن نصوغ أقوى صورةٍ منصفة ممكنة لهذا المنظور البديل، كي يقرأ المستخدم النزاع في سياقٍ متوازن.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-serif text-slate-900 dark:text-white font-medium">٣. سياسة الصياغة المحايدة</h2>
              <p>
                ضمانًا للحياد، تمرّ كل التقارير المُولَّدة عبر طبقة حمايةٍ لغوية صارمة. تُستبدَل تلقائيًا أي عباراتٍ توحي بأحكامٍ أخلاقية قاطعة أو باتهامٍ مباشر بالكذب أو بيقينٍ مطلق، بصياغاتٍ مشروطة وموضوعية (مثل: «يبدو أنه يدّعي»، «يعترض على هذا التصوير»).
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-serif text-slate-900 dark:text-white font-medium">٤. شفافية الاستشهاد بالمصادر</h2>
              <p>
                نُقدّم المصادر الأولية (البيانات الرسمية للمؤسسات، والملفات القضائية، والنصوص الحرفية المباشرة) على التقارير الصحفية الثانوية. ويُصنَّف كل مصدرٍ بحسب قوّته على نحوٍ واضح:
              </p>
              <ul className={`list-disc space-y-1 text-neutral-500 dark:text-neutral-400 text-xs ${lang === 'ar' ? 'pr-5' : 'pl-5'}`}>
                <li><strong>قوي:</strong> أدلّةٌ مباشرة غير وسيطة (كمذكّرات المحاكم والبيانات الصحفية الرسمية).</li>
                <li><strong>متوسط:</strong> تقاريرُ صحفية متوازنة أو سياقاتٌ تنظيمية موثوقة.</li>
                <li><strong>ضعيف:</strong> ادعاءاتٌ عامة غير مؤكَّدة أو منشورات رأيٍ ومدوّناتٌ بلا إسناد.</li>
              </ul>
            </section>
