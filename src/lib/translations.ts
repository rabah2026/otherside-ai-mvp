...
const ar: Translations = {
  ...
  hero_title_end: '.',
  hero_desc: 'الصق ادعاءً أو مقالاً أو تغريدة أو روايةً تاريخية. يعرض الجانب الآخر القصة المقابلة والمراجع الداعمة لها دون إصدار حكم.',
  ...
  footer_copy: 'الجانب الآخر © ٢٠٢٦. غير حزبي وموضوعي بالتصميم.',
  ...
  workspace_footer: 'الجانب الآخر © ٢٠٢٦. جميع المصادر محمية بضمانات الحياد اللغوي.',
  ...
  examples_desc: 'أمثلة مكتوبة مسبقاً توضح كيفية بناء الجانب الآخر لتقرير الموقف المقابل. هذه ليست مخرجات ذكاء اصطناعي فعلية — بل تستعرض صيغة التقرير.',
  ...
  about_s1_body: 'لا يتحكم الجانب الآخر في النزاعات ولا يُقرر الصواب المطلق ولا يُصدر أحكاماً. نرفض التصنيف الثنائي للمسائل المعقدة. برنامجنا مبني فقط لعرض المنظور المقابل للرواية المُدخلة.',
  ...
  about_disclaimer_body: 'صُمم الجانب الآخر كمحرك تركيبي محايد للمراجع. لا يحل محل البحث القانوني أو المالي أو الأكاديمي المستقل. استخدم بمسؤولية.',
